...
Page({
  ...
  onLoad: function (options) {
    ...
    if (wx.getStorageSync('start_longitude') == undefined || wx.getStorageSync('start_latitude') == undefined) {
      wx.getLocation({
        type: "gcj02",
        success: (res) => {
          console.log(res);
          wx.setStorageSync('start_longitude', res.longitude);
          wx.setStorageSync('start_latitude', res.latitude);
        }
      })
    }
