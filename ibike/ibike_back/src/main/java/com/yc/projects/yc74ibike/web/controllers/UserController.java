...
import com.yc.projects.yc74ibike.utils.YcConstants;
...
public class UserController {
	...
	private final String WXSERVER = "https://api.weixin.qq.com/sns/jscode2session?appid=" + YcConstants.APPID
			+ "&secret=" + YcConstants.SECRET + "&grant_type=authorization_code";
	...
	@PostMapping("/verify")
	public @ResponseBody JsonModel checkSmsCode(JsonModel jm, User user) {
		boolean flag = false;
		try {
